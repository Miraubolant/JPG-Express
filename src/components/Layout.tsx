          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center space-x-4">
              <a
                ...
                className="inline-flex items-center px-3 sm:px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 rounded-md transition-colors"
              >
                <ExternalLink className="w-4 h-4 mr-1.5 sm:mr-2 flex-shrink-0" />
                <span className="whitespace-nowrap">Rename Express</span>
              </a>
              <ThemeToggle />
            </div>
          </div>
